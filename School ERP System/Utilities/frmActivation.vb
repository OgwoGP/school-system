    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If txtActivationID.Text = TextBox1.Text Then
                ...
                Me.Hide()
            Else
                MessageBox.Show("Invalid activation id...Please contact software provider for buying full licence" & vbCrLf & "Contact us at :" & vbCrLf & "InfoSpace" & vbCrLf & "Email-help.infospace@gmail.com" & vbCrLf & "Skype - DigitalMayu", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
