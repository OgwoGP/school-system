...
Public Class rptFine_Staff
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_ERP_System.rptFine_Staff.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFine_Staff
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFine_Staff = New rptFine_Staff()
        rpt.Site = Me.Site
        Return rpt
    End Function
