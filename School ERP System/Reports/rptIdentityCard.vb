...
Public Class rptIdentityCard
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_ERP_System.rptIdentityCard.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIdentityCard
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIdentityCard = New rptIdentityCard()
        rpt.Site = Me.Site
        Return rpt
    End Function
