...
Public Class rptMarksheetLedger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_ERP_System.rptMarksheetLedger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMarksheetLedger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMarksheetLedger = New rptMarksheetLedger()
        rpt.Site = Me.Site
        Return rpt
    End Function
