...
Public Class rptBookReservation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_ERP_System.rptBookReservation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBookReservation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBookReservation = New rptBookReservation()
        rpt.Site = Me.Site
        Return rpt
    End Function
