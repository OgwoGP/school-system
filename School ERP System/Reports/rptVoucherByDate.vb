...
Public Class rptVoucherByDate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_ERP_System.rptVoucherByDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVoucherByDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVoucherByDate = New rptVoucherByDate()
        rpt.Site = Me.Site
        Return rpt
    End Function
