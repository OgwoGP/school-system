...
Public Class rptBookIssue_Staff
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_ERP_System.rptBookIssue_Staff.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBookIssue_Staff
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBookIssue_Staff = New rptBookIssue_Staff()
        rpt.Site = Me.Site
        Return rpt
    End Function
