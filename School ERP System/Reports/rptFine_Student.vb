...
Public Class rptFine_Student
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_ERP_System.rptFine_Student.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFine_Student
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFine_Student = New rptFine_Student()
        rpt.Site = Me.Site
        Return rpt
    End Function
