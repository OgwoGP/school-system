...
Public Class rptPurchasedBooks
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "School_ERP_System.rptPurchasedBooks.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchasedBooks
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchasedBooks = New rptPurchasedBooks()
        rpt.Site = Me.Site
        Return rpt
    End Function
