...
Module ModFunc
    ...
    Public Function HandleRegistry() As Boolean
        ...
        Dim st As Date = My.Computer.Registry.GetValue("HKEY_LOCAL_MACHINE\SOFTWARE\SchoolERP4", "Set", Nothing)
        firstRunDate = st
        If firstRunDate = Nothing Then
            firstRunDate = System.DateTime.Today.Date
            My.Computer.Registry.SetValue("HKEY_LOCAL_MACHINE\SOFTWARE\SchoolERP4", "Set", firstRunDate)
