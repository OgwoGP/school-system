...
Public Class frmPartialDueList_Staff
    ...
    Sub fillSession()
        Try
            ...
            adp.SelectCommand = New SqlCommand("SELECT distinct (Session) FROM BusFeepayment_Staff", con)
            ds = New DataSet("ds")
            adp.Fill(ds)
            dtable = ds.Tables(0)
    ...
    Private Sub Button8_Click(sender As System.Object, e As System.EventArgs) Handles Button8.Click
        Try
            ...
            Timer1.Enabled = True
            Dim rpt As New rptBusFeePartialDue_Staff 'The report you created.
